...
|--[ ]machineA_leftSensor--[ ]machineA_rightSensor--[/]machineA_startPos------------------------------------------------------------------------------------------( )machineA_topOrangeLight--|
...
|--[ ]machineB_leftSensor--[ ]machineB_rightSensor--[/]machineB_startPos------------------------------------------------------------------------------------------( )machineB_topOrangeLight--|
...
|--[ ]machineC_leftSensor--[ ]machineC_rightSensor--[/]machineC_startPos------------------------------------------------------------------------------------------( )machineC_topOrangeLight--|
